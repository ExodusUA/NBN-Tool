...
export default function Content() {
  return (
    <>
      ...
      >
        <Link href="/questions">
          <button className="socialBold text-[24px] customDes:text-[32px] bg-white rounded-[72px] py-3 w-[360px] mt-12 text-center  active:bg-gray-200 focus:outline-none focus:ring focus:ring-gray-100 duration-200 outline-none">
            Get started
          </button>
        </Link>
      </motion.div>
